...
public:
    ...
    private:
        ...
        /*
         * (Package-private) Returns the mode indicator bits, which is an unsigned 4-bit value
         * (range 0 to 15).
         */
    public:
...
private:
     ...
     * have 2953 or fewer UTF-8 code units (not Unicode code points) if the low error correction
     * level is used. The smallest possible QR Code version is automatically chosen for the output.
...
public:
     ...
     * chosen for the output. The ECC level of the result may be higher than the ecl argument if it
     * can be done without increasing the version.
     */
public:
...
private:
    ...
    // multiple of 8. The result is in the range [208, 29648]. This could be implemented as a
    // 40-entry lookup table.
private:
    ...
    // discarded. This stateless pure function could be implemented as a (40*4)-cell lookup table.
private:
